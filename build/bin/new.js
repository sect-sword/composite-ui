 ...
 *      将类型声明文件在 /types/composite-ui.d.ts 中自动引入
...
export default {
  name: 'El${ComponentName}'
   ...
   // 2种语言的文档，/examples/docs/{lang}/city.md，并设置文件标题
   {
...
// 将组件的类型声明文件在 composite-ui.d.ts 中引入
// const elementTsPath = path.join(__dirname, '../../types/composite-ui.d.ts');
