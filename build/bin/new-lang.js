...
const componentNew = Object.assign({}, componentFile.filter(item => item.lang === 'en-US')[0], { lang });
...
const pageNew = Object.assign({}, pageFile.filter(item => item.lang === 'en-US')[0], { lang });
